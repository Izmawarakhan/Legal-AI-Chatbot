...
def save_session_to_db(session_id, title, category, religion, user_id=None):
...
async def new_chat_session(religion: str = "Muslim", user_id: str = None):
    ...
    # Save to MongoDB
    save_session_to_db(session_id, "New Chat", None, religion, user_id)
